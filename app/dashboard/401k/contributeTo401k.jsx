...
export default function FourZeroOnePage({ contributeTo401k }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white px-4 pb-12">
      ...
      <div className="max-w-5xl mx-auto my-8 bg-slate-900 border border-slate-800 rounded-2xl shadow-lg p-6">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-md mx-auto">
              ...
              <form onSubmit={handleContribution} className="flex flex-col gap-4 mt-4">
                <div>
                  ...
                  <Select value={selectedCoin} onValueChange={setSelectedCoin} disabled={pending}>
                    <SelectTrigger className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-white w-full">
